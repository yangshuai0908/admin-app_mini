...
function initRuntimeSocketService() {
  const hosts = "192.168.110.159,127.0.0.1,172.27.112.1";
  const port = "8090";
  const id = "mp-weixin_OT71O4";
...
function error(err) {
  {
    index$1.__f__("error", "at node_modules/uview-plus/libs/function/index.js:318", `uView提示：${err}`);
  }
}
