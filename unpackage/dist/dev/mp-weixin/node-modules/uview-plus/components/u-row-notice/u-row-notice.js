...
const _sfc_main = {
  ...
  watch: {
    text: {
      ...
      handler(newValue, oldValue) {
        this.vue();
        if (!common_vendor.test.string(newValue)) {
          common_vendor.error("noticebar组件direction为row时，要求text参数为字符串形式");
        }
      }
    },
    fontSize() {
  ...
  methods: {
    init() {
      this.vue();
      if (!common_vendor.test.string(this.text)) {
        common_vendor.error("noticebar组件direction为row时，要求text参数为字符串形式");
      }
    },
    // vue版处理
    async vue() {
      ...
      this.animationDuration = `${textWidth / common_vendor.getPx(this.speed)}s`;
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-462e724c"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/node-modules/uview-plus/components/u-row-notice/u-row-notice.js.map
